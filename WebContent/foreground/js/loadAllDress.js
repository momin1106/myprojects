...
function loadAll() {
	$
			.post(
					"/tbpoject/business2/getallgoodsbysortid",
					{"sortid":2},
					function(data) {
...
function sortBySales() {
	$
			.post(
					"/tbpoject/business/groupbysales",
					{
						"sortid" : 1
					},
					function(data) {
...
function sortByPrice() {
	...
	$
			.post(
					"/tbpoject/business/groupbypriceandrange",
					{
						"sortid" : 1,
						"min" : min,
						"max" : max
...
function search() {
	$("#local100").click(function() {
		$.post('/tbpoject/goodsControler/setSearch', {
			"searchValue" : $(".search-combobox-input").val()
